<template>
  <div class="flex flex-col h-screen bg-gray-50 font-sans text-gray-900 overflow-hidden relative pb-16">
    ...
    <!-- Sub-menu: Tính Năng -->
    <transition name="slide-up">
      <div v-if="openMenu === 'settings'" class="fixed bottom-16 left-0 right-0 z-40 mx-auto max-w-md px-3 pb-2 max-h-[80vh] overflow-y-auto hide-scrollbar">
        <div class="bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden">
          ...
          <Link :href="route('admin.users.permissions')" @click="openMenu = null"
            ...
            <div>
              <p class="text-sm font-bold text-gray-900">Tính năng & Phân quyền</p>
          ...
          <Link :href="route('admin.chronicles.index')" @click="openMenu = null"
            ...
            <div>
              <p class="text-sm font-bold text-gray-900">Sổ tay Hội Thánh</p>
              <p class="text-xs text-gray-400">Biên niên sử sự kiện trọng đại</p>
            </div>
            <svg class="w-4 h-4 text-gray-400 ml-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
          </Link>
          <Link :href="route('admin.activity.logs')" @click="openMenu = null"
            class="flex items-center gap-3 px-4 py-3.5 hover:bg-slate-50 transition-colors border-b border-gray-100">
            <div class="w-9 h-9 rounded-xl bg-slate-100 flex items-center justify-center shrink-0">
            ...
            <div>
              <p class="text-sm font-bold text-gray-900">Nhật Ký Hoạt Động</p>
              <p class="text-xs text-gray-400">Tra cứu System Audit Logs</p>
            </div>
            <svg class="w-4 h-4 text-gray-400 ml-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
          </Link>
          ...
          <Link :href="route('admin.assets.index')" @click="openMenu = null"
            ...
            <div>
              ...
              <p class="text-xs text-gray-400">Quản lý cơ sở vật chất</p>
            </div>
            <svg class="w-4 h-4 text-gray-400 ml-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
          </Link>
          <Link :href="route('documents.index')" @click="openMenu = null"
            ...
            <div>
              ...
              <p class="text-xs text-gray-400">Lưu trữ văn bản đám mây</p>
            </div>
            <svg class="w-4 h-4 text-gray-400 ml-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
          </Link>
    ...
    <nav class="bg-white border-t border-gray-200 fixed bottom-0 w-full z-20 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] pb-safe-area-inset">
      <div class="flex justify-around items-center h-16 w-full max-w-md mx-auto">
        ...
        <!-- Tab 1: Tính Năng (Replaced old Trang Chủ) -->
        <button @click="toggleMenu('settings')"
          ...
          :class="openMenu === 'settings' ? 'text-blue-600' : 'text-gray-500 hover:text-gray-900'">
          <div class="relative">
            <svg class="w-6 h-6" :fill="openMenu === 'settings' ? 'currentColor' : 'none'" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"/>
            </svg>
            <span v-if="openMenu === 'settings'" class="absolute -top-1 -right-1 w-2 h-2 rounded-full bg-blue-500"></span>
          </div>
          <span class="text-[10px] font-medium">Tính Năng</span>
        </button>
