  ...
  <component :is="currentLayout">
    ...
    <div class="py-4 space-y-5">
      ...
      <div class="flex flex-wrap items-center gap-2">
        ...
        <a v-if="route().has('ministry.education.index')" :href="route('ministry.education.index')" class="inline-flex items-center gap-1.5 px-4 py-2.5 bg-indigo-50 text-indigo-700 border border-indigo-200 rounded-xl text-sm font-bold hover:bg-indigo-100 transition-colors">
