<template>
  <component :is="currentLayout">
    ...
    <div class="py-4 space-y-6 w-full">
        <div class="bg-gradient-to-br from-indigo-900 to-purple-900 rounded-3xl p-8 text-white shadow-lg relative overflow-hidden">
           ...
           <div class="flex flex-col md:flex-row justify-between items-start md:items-end relative z-10">
               ...
               <div class="mt-6 md:mt-0">
                   <button @click="showCreateSlide = true" class="bg-white text-indigo-900 hover:bg-indigo-50 font-bold py-3 px-6 rounded-xl shadow transition-colors inline-flex items-center">
        ...
        <!-- Create Broadcast Slide Over -->
        <SlideOver v-model="showCreateSlide" title="Soạn Thảo Email Thông Báo" description="Soạn thảo và gửi Email hàng loạt tới tất cả Tín hữu hoặc theo từng Ban ngành cụ thể." size="2xl">
            <form id="create-broadcast-form" @submit.prevent="submit" class="space-y-6 pb-4">
                <div>
            ...
            <template #footer>
                <div class="flex items-center justify-between w-full">
                    <SecondaryButton type="button" @click="showCreateSlide = false">
                        Huỷ Bỏ
                    </SecondaryButton>
                    <div class="space-x-3 flex">
                        ...
                        <PrimaryButton type="submit" form="create-broadcast-form" class="bg-indigo-600 hover:bg-indigo-700 py-2.5 px-6 font-bold" :disabled="form.processing">
...
const props = defineProps(['broadcasts', 'roles', 'departments']);
